...
export function MapComponent({ onAddress }: MapProps) {
  ...
  const handleNewAddress = (addressObject: AddressObject) => {
    ...
    const zip = addressObject.postcode;
    onAddress(createAddress(street, city, state, zip));
  };
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <p className="sm:text-md md:text-sm">
        <span className="font-bold">Note: </span>Parking Lots can only operate
